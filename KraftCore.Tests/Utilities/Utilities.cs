    ...
    internal static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            HydraFaker = new Faker<Hydra>()
                ...
                .RuleFor(t => t.IntegerArray, f => GetRandomItems(Enumerable.Range(1, 5000)).ToArray())
                .RuleFor(t => t.NullableIntegerArray, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t.OrNull(f)).ToArray())
                .RuleFor(t => t.IntegerCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).ToList())
                .RuleFor(t => t.NullableIntegerCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t.OrNull(f)).ToList())
                //// Floats
                .RuleFor(t => t.Float, f => (float)f.Random.Int() / 3)
                .RuleFor(t => t.NullableFloat, f => ((float)f.Random.Int() / 3).OrNull(f))
                .RuleFor(t => t.FloatArray, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t / 3f).ToArray())
                .RuleFor(t => t.NullableFloatArray, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => (t / 3f).OrNull(f)).ToArray())
                .RuleFor(t => t.FloatCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t / 3f).ToList())
                .RuleFor(t => t.NullableFloatCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => (t / 3f).OrNull(f)).ToList())
                //// Doubles
                .RuleFor(t => t.Double, f => (double)f.Random.Int() / 3)
                .RuleFor(t => t.NullableDouble, f => ((double)f.Random.Int() / 3).OrNull(f))
                .RuleFor(t => t.DoubleArray, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t / 3d).ToArray())
                .RuleFor(t => t.NullableDoubleArray, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => (t / 3d).OrNull(f)).ToArray())
                .RuleFor(t => t.DoubleCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t / 3d).ToList())
                .RuleFor(t => t.NullableDoubleCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => (t / 3d).OrNull(f)).ToList())
                //// Decimals
                .RuleFor(t => t.Decimal, f => (decimal)f.Random.Int() / 3)
                .RuleFor(t => t.NullableDecimal, f => ((decimal)f.Random.Int() / 3).OrNull(f))
                .RuleFor(t => t.DecimalArray, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t / 3m).ToArray())
                .RuleFor(t => t.NullableDecimalArray, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => (t / 3m).OrNull(f)).ToArray())
                .RuleFor(t => t.DecimalCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => t / 3m).ToList())
                .RuleFor(t => t.NullableDecimalCollection, f => GetRandomItems(Enumerable.Range(1, 5000)).Select(t => (t / 3m).OrNull(f)).ToList())
                //// DateTimes
