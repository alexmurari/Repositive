namespace KraftCore.Tests.Projects.Shared.DynamicQueryBuilder
{
    ...
    public class DynamicQueryBuilderDateTimeTests : DynamicQueryBuilderTestsBase
    {
        ...
        /// <summary>
        /// Asserts that an greater than or equal query with single element of DateTime type gives correct result when executed.
        /// </summary>
        [Fact]
        ...
        public void Assert_Equality_Query_With_Single_Element_Of_Nullable_DateTime_Type_Gives_Correct_Result()
        {
            // Arrange
            var randomPerson = Utilities.GetRandomItem(Persons);
            var query = DynamicQueryBuilder.Build<Person>(BuildQueryText(ExpressionOperator.Equal, nameof(Person.DateOfDriversLicense), randomPerson.DateOfDriversLicense.GetValueOrDefault().ToString("O")));
        ...
        public void Assert_Non_Equality_Query_With_Single_Element_Of_Nullable_DateTime_Type_Gives_Correct_Result()
        {
            // Arrange
            var randomPerson = Utilities.GetRandomItem(Persons);
            var query = DynamicQueryBuilder.Build<Person>(BuildQueryText(ExpressionOperator.NotEqual, nameof(Person.DateOfDriversLicense), randomPerson.DateOfDriversLicense.GetValueOrDefault().ToString("O")));
        ...
        public void Assert_Less_Than_Query_With_Single_Element_Of_Nullable_DateTime_Type_Gives_Correct_Result()
        {
            // Arrange
            var randomPerson = Utilities.GetRandomItem(Persons);
            var query = DynamicQueryBuilder.Build<Person>(BuildQueryText(ExpressionOperator.LessThan, nameof(Person.DateOfDriversLicense), randomPerson.DateOfDriversLicense.GetValueOrDefault().ToString("O")));
        ...
        public void Assert_Less_Than_Or_Equal_Query_With_Single_Element_Of_Nullable_DateTime_Type_Gives_Correct_Result()
        {
            // Arrange
            var randomPerson = Utilities.GetRandomItem(Persons);
            var query = DynamicQueryBuilder.Build<Person>(BuildQueryText(ExpressionOperator.LessThanOrEqual, nameof(Person.DateOfDriversLicense), randomPerson.DateOfDriversLicense.GetValueOrDefault().ToString("O")));
        ...
        public void Assert_Greater_Than_Query_With_Single_Element_Of_Nullable_DateTime_Type_Gives_Correct_Result()
        {
            // Arrange
            var randomPerson = Utilities.GetRandomItem(Persons);
            var query = DynamicQueryBuilder.Build<Person>(BuildQueryText(ExpressionOperator.GreaterThan, nameof(Person.DateOfDriversLicense), randomPerson.DateOfDriversLicense.GetValueOrDefault().ToString("O")));
        ...
        public void Assert_Greater_Than_Or_Equal_Query_With_Single_Element_Of_Nullable_DateTime_Type_Gives_Correct_Result()
        {
            // Arrange
            var randomPerson = Utilities.GetRandomItem(Persons);
            var query = DynamicQueryBuilder.Build<Person>(BuildQueryText(ExpressionOperator.GreaterThanOrEqual, nameof(Person.DateOfDriversLicense), randomPerson.DateOfDriversLicense.GetValueOrDefault().ToString("O")));
        ...
        public void Assert_Contains_On_Value_Query_With_Single_Element_Of_Nullable_DateTime_Type_Gives_Correct_Result()
        {
            ...
            var query = DynamicQueryBuilder.Build<Person>(BuildQueryText(ExpressionOperator.ContainsOnValue, nameof(Person.DateOfDriversLicense), string.Join(',', randomAge.Select(x => $"'{x:O}'"))));
