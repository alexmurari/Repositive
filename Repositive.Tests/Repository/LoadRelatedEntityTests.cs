namespace Repositive.Tests.Repository
{
    ...
    public class LoadRelatedEntityTests
    {
        ...
        ///     The vehicle repository.
        /// </param>
        public LoadRelatedEntityTests(IPersonRepository personRepository, DatabaseHelper databaseHelper, IVehicleRepository vehicleRepository)
        {
        ...
        /// <summary>
        ///     Asserts that the <see cref="IGenericRepository{TEntity}.LoadRelated{TProperty}(TEntity, Expression{Func{TEntity, TProperty}}, Expression{Func{TProperty, object}}[])"/> is operating correctly.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Asserts that the <see cref="IGenericRepository{TEntity}.LoadRelated{TProperty}(TEntity, Expression{Func{TEntity, TProperty}}, Expression{Func{TProperty, object}}[])"/>
        ...
        /// <summary>
        ///     Asserts that the <see cref="IGenericRepository{TEntity}.LoadRelated{TProperty}(TEntity, Expression{Func{TEntity, TProperty}}, Expression{Func{TProperty, bool}}, Expression{Func{TProperty, object}}[])"/> is operating correctly.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Asserts that the <see cref="IGenericRepository{TEntity}.LoadRelatedCollection{TProperty}(TEntity, Expression{Func{TEntity, IEnumerable{TProperty}}}, Expression{Func{TProperty, object}}[])"/> is operating correctly.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Asserts that the <see cref="IGenericRepository{TEntity}.LoadRelatedCollection{TProperty}(TEntity, Expression{Func{TEntity, IEnumerable{TProperty}}}, Expression{Func{TProperty, object}}[])"/>
        ///     is operating correctly when the include parameter is defined.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     Asserts that the <see cref="IGenericRepository{TEntity}.LoadRelatedCollection{TProperty}(TEntity, Expression{Func{TEntity, IEnumerable{TProperty}}}, Expression{Func{TProperty, bool}}, Expression{Func{TProperty, object}}[])"/> is operating correctly.
        /// </summary>
        [Fact]
